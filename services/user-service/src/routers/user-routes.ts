...
router.post('/', validate(createUserSchema, 'body'), controller.create.bind(controller));

router.get('/health', controller.health.bind(controller));

router.get('/', controller.findAll.bind(controller));

router.get('/id/:id', validate(idParamSchema, 'params'), controller.findById.bind(controller));
...
router.get('/cpf/:cpf', validate(cpfParamSchema, 'params'), controller.findByCpf.bind(controller));
